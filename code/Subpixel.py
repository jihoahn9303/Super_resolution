...
class Subpixel(Conv2D):
    ...
    def _phase_shift(self, I):
        r = self.r
        batch_size, a, b, c = I.get_shape().as_list() # [None, a, b, c]
        batch_size = K.shape(I)[0] # Handling Dimension(None) type for undefined batch dim
        X = K.reshape(I, [batch_size, a, b, int(c/(r*r)),r, r]) # bsize, a, b, c/(r*r), r, r
